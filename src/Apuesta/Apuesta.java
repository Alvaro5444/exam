...
public class Apuesta {
     ...
     * @param dinero Introducimos un parametro entero llamado dinero
     * @throws Exception Recogemos que en caso de que el dinero sea menor de 0 mandar un mensaje
     */
     ...
     * @param local introducimos un parametro entero llamado local
     * @param visitante introducimos un parametro enteto llamado visitante
     * @return devolcemos un true o un false
     * @throws Exception Recogemos en caso de que halla menos de 0 goles decircelo al usuario
     */
